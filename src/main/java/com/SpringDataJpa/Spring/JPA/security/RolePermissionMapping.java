...
import com.SpringDataJpa.Spring.JPA.entity.type.PermissionType;
...
public class RolePermissionMapping {
    ...
    private static final Map<RoleType, Set<PermissionType>> map = Map.of(
            ...
            ADMIN, Set.of(PATIENT_READ, PATIENT_WRITE, APPOINTMENT_READ, APPOINTMENT_WRITE,
                        APPOINTMENT_DELETE, USER_MANAGE, REPORT_VIEW)
    );
